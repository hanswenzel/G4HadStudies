...
void readall() 
{
  ...
  for (int i=0;i<G4sets;i++)
      ...
      else 
	{
      ...
      title[i] = Particles[i]+" on Ar Cross section";
      ...
      grtot[i]->SetTitle(title[i].c_str());
